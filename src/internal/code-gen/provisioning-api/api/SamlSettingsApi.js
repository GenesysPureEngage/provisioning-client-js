...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiErrorResponse', 'model/GetAnyLocationsResponse', 'model/GetEnabledResponse', 'model/GetLocationResponse', 'model/GetSPMetadataResponse', 'model/SendMetadataResponse', 'model/SetAnyLocationsResponse', 'model/SetEnabledResponse', 'model/SettingsData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiErrorResponse'), require('../model/GetAnyLocationsResponse'), require('../model/GetEnabledResponse'), require('../model/GetLocationResponse'), require('../model/GetSPMetadataResponse'), require('../model/SendMetadataResponse'), require('../model/SetAnyLocationsResponse'), require('../model/SetEnabledResponse'), require('../model/SettingsData'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.SamlSettingsApi = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.ApiErrorResponse, root.ProvisioningApi.GetAnyLocationsResponse, root.ProvisioningApi.GetEnabledResponse, root.ProvisioningApi.GetLocationResponse, root.ProvisioningApi.GetSPMetadataResponse, root.ProvisioningApi.SendMetadataResponse, root.ProvisioningApi.SetAnyLocationsResponse, root.ProvisioningApi.SetEnabledResponse, root.ProvisioningApi.SettingsData);
  }
}(this, function(ApiClient, ApiErrorResponse, GetAnyLocationsResponse, GetEnabledResponse, GetLocationResponse, GetSPMetadataResponse, SendMetadataResponse, SetAnyLocationsResponse, SetEnabledResponse, SettingsData) {
  'use strict';
