...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiEndpointsSuccess', 'model/ApiPostEndpointsSuccess', 'model/PostSettings', 'model/Templates'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiEndpointsSuccess'), require('../model/ApiPostEndpointsSuccess'), require('../model/PostSettings'), require('../model/Templates'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.SettingsApi = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.ApiEndpointsSuccess, root.ProvisioningApi.ApiPostEndpointsSuccess, root.ProvisioningApi.PostSettings, root.ProvisioningApi.Templates);
  }
}(this, function(ApiClient, ApiEndpointsSuccess, ApiPostEndpointsSuccess, PostSettings, Templates) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.deleteApiEndpointsWithHttpInfo = function() {
      var postBody = null;
     ...
     */
    this.deleteApiEndpoints = function() {
      return this.deleteApiEndpointsWithHttpInfo()
