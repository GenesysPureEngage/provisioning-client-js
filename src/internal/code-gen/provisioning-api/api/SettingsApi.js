...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiEndpointsSuccess', 'model/Templates'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiEndpointsSuccess'), require('../model/Templates'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.SettingsApi = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.ApiEndpointsSuccess, root.ProvisioningApi.Templates);
  }
}(this, function(ApiClient, ApiEndpointsSuccess, Templates) {
  'use strict';
