...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiAsyncSuccessResponse', 'model/ApiErrorResponse', 'model/DeleteUsers', 'model/GetSubResponse', 'model/PostCheckImportStatus', 'model/PostCheckInactivity', 'model/PostImportResponse', 'model/PostUsers', 'model/PostValidateImportResponse', 'model/PutUsers'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiAsyncSuccessResponse'), require('../model/ApiErrorResponse'), require('../model/DeleteUsers'), require('../model/GetSubResponse'), require('../model/PostCheckImportStatus'), require('../model/PostCheckInactivity'), require('../model/PostImportResponse'), require('../model/PostUsers'), require('../model/PostValidateImportResponse'), require('../model/PutUsers'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.OperationsApi = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.ApiAsyncSuccessResponse, root.ProvisioningApi.ApiErrorResponse, root.ProvisioningApi.DeleteUsers, root.ProvisioningApi.GetSubResponse, root.ProvisioningApi.PostCheckImportStatus, root.ProvisioningApi.PostCheckInactivity, root.ProvisioningApi.PostImportResponse, root.ProvisioningApi.PostUsers, root.ProvisioningApi.PostValidateImportResponse, root.ProvisioningApi.PutUsers);
  }
}(this, function(ApiClient, ApiAsyncSuccessResponse, ApiErrorResponse, DeleteUsers, GetSubResponse, PostCheckImportStatus, PostCheckInactivity, PostImportResponse, PostUsers, PostValidateImportResponse, PutUsers) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.deleteUsersWithHttpInfo = function() {
      var postBody = null;
    ...
    this.deleteUsers = function() {
      return this.deleteUsersWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
