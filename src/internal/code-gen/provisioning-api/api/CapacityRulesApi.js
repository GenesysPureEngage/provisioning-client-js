...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.capRulesPutWithHttpInfo = function(scriptDbid, body) {
      var postBody = body;

      // verify the required parameter 'scriptDbid' is set
      if (scriptDbid === undefined || scriptDbid === null) {
        throw new Error("Missing the required parameter 'scriptDbid' when calling capRulesPut");
      }
      ...
      return this.apiClient.callApi(
        '/capacity-rules/{script_dbid}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    this.capRulesPut = function(scriptDbid, body) {
      return this.capRulesPutWithHttpInfo(scriptDbid, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    this.capruleDeleteWithHttpInfo = function(scriptDbid) {
      ...
      return this.apiClient.callApi(
        '/capacity-rules/{script_dbid}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
