...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiErrorResponse', 'model/CheckPostMigrateStatistic', 'model/DeleteAgentStatisticResponse', 'model/DeleteGroupAgentStatisticResponse', 'model/DeleteGroupQueuesStatisticResponse', 'model/DeleteQueueStatisticResponse', 'model/DeleteRoutePointStatisticResponse', 'model/GetExportStatisticDefinitions', 'model/GetStatisticDefinitionsResponse', 'model/GetSubResponse', 'model/PostImportStatisticDefinitions', 'model/PostUpdateResetTimesStatistics'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ApiErrorResponse'), require('../model/CheckPostMigrateStatistic'), require('../model/DeleteAgentStatisticResponse'), require('../model/DeleteGroupAgentStatisticResponse'), require('../model/DeleteGroupQueuesStatisticResponse'), require('../model/DeleteQueueStatisticResponse'), require('../model/DeleteRoutePointStatisticResponse'), require('../model/GetExportStatisticDefinitions'), require('../model/GetStatisticDefinitionsResponse'), require('../model/GetSubResponse'), require('../model/PostImportStatisticDefinitions'), require('../model/PostUpdateResetTimesStatistics'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.StatisticsApi = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.ApiErrorResponse, root.ProvisioningApi.CheckPostMigrateStatistic, root.ProvisioningApi.DeleteAgentStatisticResponse, root.ProvisioningApi.DeleteGroupAgentStatisticResponse, root.ProvisioningApi.DeleteGroupQueuesStatisticResponse, root.ProvisioningApi.DeleteQueueStatisticResponse, root.ProvisioningApi.DeleteRoutePointStatisticResponse, root.ProvisioningApi.GetExportStatisticDefinitions, root.ProvisioningApi.GetStatisticDefinitionsResponse, root.ProvisioningApi.GetSubResponse, root.ProvisioningApi.PostImportStatisticDefinitions, root.ProvisioningApi.PostUpdateResetTimesStatistics);
  }
}(this, function(ApiClient, ApiErrorResponse, CheckPostMigrateStatistic, DeleteAgentStatisticResponse, DeleteGroupAgentStatisticResponse, DeleteGroupQueuesStatisticResponse, DeleteQueueStatisticResponse, DeleteRoutePointStatisticResponse, GetExportStatisticDefinitions, GetStatisticDefinitionsResponse, GetSubResponse, PostImportStatisticDefinitions, PostUpdateResetTimesStatistics) {
  'use strict';
