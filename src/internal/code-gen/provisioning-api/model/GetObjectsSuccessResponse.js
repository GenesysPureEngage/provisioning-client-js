...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CheckMigrateConflictsStatus', 'model/GetObjectsSuccessResponseData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CheckMigrateConflictsStatus'), require('./GetObjectsSuccessResponseData'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.GetObjectsSuccessResponse = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.CheckMigrateConflictsStatus, root.ProvisioningApi.GetObjectsSuccessResponseData);
  }
}(this, function(ApiClient, CheckMigrateConflictsStatus, GetObjectsSuccessResponseData) {
  'use strict';
