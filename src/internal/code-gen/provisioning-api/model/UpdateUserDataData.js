...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Extension', 'model/Skill', 'model/UpdateUserDataDataDevConsole', 'model/UpdateUserDataDataWwe'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Extension'), require('./Skill'), require('./UpdateUserDataDataDevConsole'), require('./UpdateUserDataDataWwe'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.UpdateUserDataData = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.Extension, root.ProvisioningApi.Skill, root.ProvisioningApi.UpdateUserDataDataDevConsole, root.ProvisioningApi.UpdateUserDataDataWwe);
  }
}(this, function(ApiClient, Extension, Skill, UpdateUserDataDataDevConsole, UpdateUserDataDataWwe) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('devConsole')) {
        obj['devConsole'] = UpdateUserDataDataDevConsole.constructFromObject(data['devConsole']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/UpdateUserDataDataDevConsole} devConsole
   */
  exports.prototype['devConsole'] = undefined;
