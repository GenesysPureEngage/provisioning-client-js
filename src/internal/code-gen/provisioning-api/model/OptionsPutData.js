...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProvisioningApi.OptionsPutData = factory(root.ProvisioningApi.ApiClient);
  }
  ...
  /**
   * The OptionsPutData model module.
   * @module model/OptionsPutData
   * @version 9.0.000.65.3913
   */

  /**
   * Constructs a new <code>OptionsPutData</code>.
   * @alias module:model/OptionsPutData
   * @class
   */
  ...
  /**
   * Constructs a <code>OptionsPutData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OptionsPutData} obj Optional instance to populate.
   * @return {module:model/OptionsPutData} The populated <code>OptionsPutData</code> instance.
   */
