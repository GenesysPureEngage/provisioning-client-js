...
(function(root, factory) {
   ...
   * @module model/UsersPostResponseStatusSuccess
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>UsersPostResponseStatusSuccess</code>.
   * @alias module:model/UsersPostResponseStatusSuccess
   * @class
   */
   ...
   * @param {module:model/UsersPostResponseStatusSuccess} obj Optional instance to populate.
   * @return {module:model/UsersPostResponseStatusSuccess} The populated <code>UsersPostResponseStatusSuccess</code> instance.
   */
