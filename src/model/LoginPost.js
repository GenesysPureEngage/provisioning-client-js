...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProvisioningApi.LoginPost = factory(root.ProvisioningApi.ApiClient);
  }
  ...
  /**
   * The LoginPost model module.
   * @module model/LoginPost
   * @version 9.0.000.00.423
   */

  /**
   * Constructs a new <code>LoginPost</code>.
   * @alias module:model/LoginPost
   * @class
  ...
  /**
   * Constructs a <code>LoginPost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LoginPost} obj Optional instance to populate.
   * @return {module:model/LoginPost} The populated <code>LoginPost</code> instance.
   */
