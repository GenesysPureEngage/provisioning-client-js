...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetUsersSuccessResponseData', 'model/GetUsersSuccessResponseStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetUsersSuccessResponseData'), require('./GetUsersSuccessResponseStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.GetUsersSuccessResponse = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.GetUsersSuccessResponseData, root.ProvisioningApi.GetUsersSuccessResponseStatus);
  }
}(this, function(ApiClient, GetUsersSuccessResponseData, GetUsersSuccessResponseStatus) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = GetUsersSuccessResponseData.constructFromObject(data['data']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/GetUsersSuccessResponseData} data
   */
