...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateUserSuccessResponseStatus', 'model/GetUsersSuccessResponseData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateUserSuccessResponseStatus'), require('./GetUsersSuccessResponseData'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.GetUsersSuccessResponse = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.CreateUserSuccessResponseStatus, root.ProvisioningApi.GetUsersSuccessResponseData);
  }
}(this, function(ApiClient, CreateUserSuccessResponseStatus, GetUsersSuccessResponseData) {
  'use strict';
