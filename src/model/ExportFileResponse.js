...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ExportFileResponseStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ExportFileResponseStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.ExportFileResponse = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.ExportFileResponseStatus);
  }
}(this, function(ApiClient, ExportFileResponseStatus) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('status')) {
        obj['status'] = ExportFileResponseStatus.constructFromObject(data['status']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ExportFileResponseStatus} status
   */
