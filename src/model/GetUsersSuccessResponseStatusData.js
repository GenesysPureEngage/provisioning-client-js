...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetUsersSuccessResponseStatusDataSkills'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetUsersSuccessResponseStatusDataSkills'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.GetUsersSuccessResponseStatusData = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.GetUsersSuccessResponseStatusDataSkills);
  }
}(this, function(ApiClient, GetUsersSuccessResponseStatusDataSkills) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('skills')) {
        obj['skills'] = ApiClient.convertToType(data['skills'], [GetUsersSuccessResponseStatusDataSkills]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/GetUsersSuccessResponseStatusDataSkills>} skills
   */
