...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetOptionsResponseData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetOptionsResponseData'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.GetOptionsResponse = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.GetOptionsResponseData);
  }
}(this, function(ApiClient, GetOptionsResponseData) {
  'use strict';
