...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Extension', 'model/Skill'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Extension'), require('./Skill'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.UsersPost = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.Extension, root.ProvisioningApi.Skill);
  }
}(this, function(ApiClient, Extension, Skill) {
  'use strict';
  ...
  /**
   * The UsersPost model module.
   * @module model/UsersPost
   * @version 9.0.000.00.423
   */

  /**
   * Constructs a new <code>UsersPost</code>.
   * @alias module:model/UsersPost
   * @class
  ...
  /**
   * Constructs a <code>UsersPost</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UsersPost} obj Optional instance to populate.
   * @return {module:model/UsersPost} The populated <code>UsersPost</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('multimediaPlaceName')) {
        obj['multimediaPlaceName'] = ApiClient.convertToType(data['multimediaPlaceName'], 'String');
      }
   ...
   * @default 'usefname123'
   */
  exports.prototype['password'] = 'usefname123';
  /**
   * Place name for multimedia-only agents 
   * @member {String} multimediaPlaceName
   */
  exports.prototype['multimediaPlaceName'] = undefined;
  /**
   ...
   * @member {module:model/UsersPost.SipPhoneTypeEnum} sipPhoneType
   * @default 'DISABLE_CTI'
   */
