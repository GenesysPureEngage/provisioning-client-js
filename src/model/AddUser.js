...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddUserWwe', 'model/Extension', 'model/Skill'], factory);
  ...
  /**
   * @member {module:model/AddUserWwe} wwe
   */
   ...
   * @member {module:model/AddUser.SipPhoneTypeEnum} sipPhoneType
   * @default 'DISABLE_CTI'
   */
