...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LoginSuccessResponseStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LoginSuccessResponseStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.ApiSuccessResponse = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.LoginSuccessResponseStatus);
  }
}(this, function(ApiClient, LoginSuccessResponseStatus) {
  'use strict';
