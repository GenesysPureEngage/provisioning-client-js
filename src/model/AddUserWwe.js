...
(function(root, factory) {
   ...
   * @param {module:model/AddUserWwe} obj Optional instance to populate.
   * @return {module:model/AddUserWwe} The populated <code>AddUserWwe</code> instance.
   */
