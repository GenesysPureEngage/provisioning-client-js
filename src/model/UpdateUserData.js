...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Extension', 'model/Skill', 'model/UpdateUserDataWwe'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Extension'), require('./Skill'), require('./UpdateUserDataWwe'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.UpdateUserData = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.Extension, root.ProvisioningApi.Skill, root.ProvisioningApi.UpdateUserDataWwe);
  }
}(this, function(ApiClient, Extension, Skill, UpdateUserDataWwe) {
  'use strict';
   ...
   */
  var exports = function(password, userName, firstName, lastName) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('wwe')) {
        obj['wwe'] = UpdateUserDataWwe.constructFromObject(data['wwe']);
      }
  ...
  /**
   * @member {module:model/UpdateUserDataWwe} wwe
   */
   ...
   * @member {module:model/UpdateUserData.SipPhoneTypeEnum} sipPhoneType
   */
