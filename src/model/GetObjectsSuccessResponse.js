...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetObjectsSuccessResponseStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GetObjectsSuccessResponseStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.ProvisioningApi) {
      root.ProvisioningApi = {};
    }
    root.ProvisioningApi.GetObjectsSuccessResponse = factory(root.ProvisioningApi.ApiClient, root.ProvisioningApi.GetObjectsSuccessResponseStatus);
  }
}(this, function(ApiClient, GetObjectsSuccessResponseStatus) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('status')) {
        obj['status'] = GetObjectsSuccessResponseStatus.constructFromObject(data['status']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/GetObjectsSuccessResponseStatus} status
   */
