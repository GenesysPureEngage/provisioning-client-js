...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddUserData', 'model/AddUserDataWwe', 'model/ApiAuditSuccessResponse', 'model/ApiAuditSuccessResponseData', 'model/ApiAuditSuccessResponseDataRows', 'model/ApiErrorResponse', 'model/ApiErrorResponseStatus', 'model/ApiSuccessResponse', 'model/ChangePasswordData', 'model/DeleteUserData', 'model/ExportFileData', 'model/ExportFileDataFilterParameters', 'model/ExportFileResponse', 'model/ExportFileResponseData', 'model/ExportStatusResponse', 'model/ExportStatusResponseData', 'model/Extension', 'model/GetImportStatusResponse', 'model/GetImportStatusResponseData', 'model/GetImportStatusResponseStatus', 'model/GetObjectsSuccessResponse', 'model/GetObjectsSuccessResponseData', 'model/GetOptionsResponse', 'model/GetOptionsResponseData', 'model/GetUserSkillsSuccessResponse', 'model/GetUserSkillsSuccessResponseStatus', 'model/GetUserSkillsSuccessResponseStatusData', 'model/GetUserSkillsSuccessResponseStatusDataSkills', 'model/GetUsersSuccessResponse', 'model/GetUsersSuccessResponseStatus', 'model/GetUsersSuccessResponseStatusData', 'model/LoginData', 'model/LoginSuccessResponse', 'model/LoginSuccessResponseData', 'model/LoginSuccessResponseStatus', 'model/ModifyOptionsData', 'model/Skill', 'model/UpdateOptionsData', 'model/UpdateUserData', 'model/UpdateUserDataWwe', 'api/AuditApi', 'api/DocumentationApi', 'api/ExportApi', 'api/ImportApi', 'api/ObjectsApi', 'api/OptionsApi', 'api/SessionApi', 'api/UsersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AddUserData'), require('./model/AddUserDataWwe'), require('./model/ApiAuditSuccessResponse'), require('./model/ApiAuditSuccessResponseData'), require('./model/ApiAuditSuccessResponseDataRows'), require('./model/ApiErrorResponse'), require('./model/ApiErrorResponseStatus'), require('./model/ApiSuccessResponse'), require('./model/ChangePasswordData'), require('./model/DeleteUserData'), require('./model/ExportFileData'), require('./model/ExportFileDataFilterParameters'), require('./model/ExportFileResponse'), require('./model/ExportFileResponseData'), require('./model/ExportStatusResponse'), require('./model/ExportStatusResponseData'), require('./model/Extension'), require('./model/GetImportStatusResponse'), require('./model/GetImportStatusResponseData'), require('./model/GetImportStatusResponseStatus'), require('./model/GetObjectsSuccessResponse'), require('./model/GetObjectsSuccessResponseData'), require('./model/GetOptionsResponse'), require('./model/GetOptionsResponseData'), require('./model/GetUserSkillsSuccessResponse'), require('./model/GetUserSkillsSuccessResponseStatus'), require('./model/GetUserSkillsSuccessResponseStatusData'), require('./model/GetUserSkillsSuccessResponseStatusDataSkills'), require('./model/GetUsersSuccessResponse'), require('./model/GetUsersSuccessResponseStatus'), require('./model/GetUsersSuccessResponseStatusData'), require('./model/LoginData'), require('./model/LoginSuccessResponse'), require('./model/LoginSuccessResponseData'), require('./model/LoginSuccessResponseStatus'), require('./model/ModifyOptionsData'), require('./model/Skill'), require('./model/UpdateOptionsData'), require('./model/UpdateUserData'), require('./model/UpdateUserDataWwe'), require('./api/AuditApi'), require('./api/DocumentationApi'), require('./api/ExportApi'), require('./api/ImportApi'), require('./api/ObjectsApi'), require('./api/OptionsApi'), require('./api/SessionApi'), require('./api/UsersApi'));
  }
}(function(ApiClient, AddUserData, AddUserDataWwe, ApiAuditSuccessResponse, ApiAuditSuccessResponseData, ApiAuditSuccessResponseDataRows, ApiErrorResponse, ApiErrorResponseStatus, ApiSuccessResponse, ChangePasswordData, DeleteUserData, ExportFileData, ExportFileDataFilterParameters, ExportFileResponse, ExportFileResponseData, ExportStatusResponse, ExportStatusResponseData, Extension, GetImportStatusResponse, GetImportStatusResponseData, GetImportStatusResponseStatus, GetObjectsSuccessResponse, GetObjectsSuccessResponseData, GetOptionsResponse, GetOptionsResponseData, GetUserSkillsSuccessResponse, GetUserSkillsSuccessResponseStatus, GetUserSkillsSuccessResponseStatusData, GetUserSkillsSuccessResponseStatusDataSkills, GetUsersSuccessResponse, GetUsersSuccessResponseStatus, GetUsersSuccessResponseStatusData, LoginData, LoginSuccessResponse, LoginSuccessResponseData, LoginSuccessResponseStatus, ModifyOptionsData, Skill, UpdateOptionsData, UpdateUserData, UpdateUserDataWwe, AuditApi, DocumentationApi, ExportApi, ImportApi, ObjectsApi, OptionsApi, SessionApi, UsersApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The ChangePasswordData model constructor.
     * @property {module:model/ChangePasswordData}
     */
    ...
    /**
     * The GetUserSkillsSuccessResponse model constructor.
     * @property {module:model/GetUserSkillsSuccessResponse}
     */
    GetUserSkillsSuccessResponse: GetUserSkillsSuccessResponse,
    /**
     * The GetUserSkillsSuccessResponseStatus model constructor.
     * @property {module:model/GetUserSkillsSuccessResponseStatus}
     */
    GetUserSkillsSuccessResponseStatus: GetUserSkillsSuccessResponseStatus,
    /**
     * The GetUserSkillsSuccessResponseStatusData model constructor.
     * @property {module:model/GetUserSkillsSuccessResponseStatusData}
     */
    GetUserSkillsSuccessResponseStatusData: GetUserSkillsSuccessResponseStatusData,
    /**
     * The GetUserSkillsSuccessResponseStatusDataSkills model constructor.
     * @property {module:model/GetUserSkillsSuccessResponseStatusDataSkills}
     */
    GetUserSkillsSuccessResponseStatusDataSkills: GetUserSkillsSuccessResponseStatusDataSkills,
    /**
