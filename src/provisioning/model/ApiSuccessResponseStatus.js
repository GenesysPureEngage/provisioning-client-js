...
(function(root, factory) {
   ...
   * @module provisioning/model/ApiSuccessResponseStatus
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>ApiSuccessResponseStatus</code>.
   * @alias module:provisioning/model/ApiSuccessResponseStatus
   * @class
   */
   ...
   * @param {module:provisioning/model/ApiSuccessResponseStatus} obj Optional instance to populate.
   * @return {module:provisioning/model/ApiSuccessResponseStatus} The populated <code>ApiSuccessResponseStatus</code> instance.
   */
