...
(function(root, factory) {
   ...
   * @module provisioning/model/ApiSuccessResponse
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>ApiSuccessResponse</code>.
   * @alias module:provisioning/model/ApiSuccessResponse
   * @class
   */
   ...
   * @param {module:provisioning/model/ApiSuccessResponse} obj Optional instance to populate.
   * @return {module:provisioning/model/ApiSuccessResponse} The populated <code>ApiSuccessResponse</code> instance.
   */
