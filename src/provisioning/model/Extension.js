...
(function(root, factory) {
   ...
   * @module provisioning/model/Extension
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>Extension</code>.
   * @alias module:provisioning/model/Extension
   * @class
   */
   ...
   * @param {module:provisioning/model/Extension} obj Optional instance to populate.
   * @return {module:provisioning/model/Extension} The populated <code>Extension</code> instance.
   */
