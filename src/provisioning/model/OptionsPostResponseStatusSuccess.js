...
(function(root, factory) {
   ...
   * @module provisioning/model/OptionsPostResponseStatusSuccess
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>OptionsPostResponseStatusSuccess</code>.
   * @alias module:provisioning/model/OptionsPostResponseStatusSuccess
   * @class
   */
   ...
   * @param {module:provisioning/model/OptionsPostResponseStatusSuccess} obj Optional instance to populate.
   * @return {module:provisioning/model/OptionsPostResponseStatusSuccess} The populated <code>OptionsPostResponseStatusSuccess</code> instance.
   */
