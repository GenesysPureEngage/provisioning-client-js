...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['provisioning/ApiClient', 'provisioning/model/Extension', 'provisioning/model/Skill', 'provisioning/model/UsersPutWwe'], factory);
   ...
   * @module provisioning/model/UsersPut
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>UsersPut</code>.
   * @alias module:provisioning/model/UsersPut
   * @class
   ...
   * @param {module:provisioning/model/UsersPut} obj Optional instance to populate.
   * @return {module:provisioning/model/UsersPut} The populated <code>UsersPut</code> instance.
   */
  ...
  /**
   * @member {module:provisioning/model/UsersPutWwe} wwe
   */
   ...
   * @member {module:provisioning/model/UsersPut.SipPhoneTypeEnum} sipPhoneType
   */
