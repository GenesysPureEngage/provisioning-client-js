...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['provisioning/ApiClient', 'provisioning/model/UsersGetResponseStatusSuccessDataSkills'], factory);
   ...
   * @module provisioning/model/UsersGetResponseStatusSuccessData
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>UsersGetResponseStatusSuccessData</code>.
   * @alias module:provisioning/model/UsersGetResponseStatusSuccessData
   * @class
   */
   ...
   * @param {module:provisioning/model/UsersGetResponseStatusSuccessData} obj Optional instance to populate.
   * @return {module:provisioning/model/UsersGetResponseStatusSuccessData} The populated <code>UsersGetResponseStatusSuccessData</code> instance.
   */
   ...
   * @member {Array.<module:provisioning/model/UsersGetResponseStatusSuccessDataSkills>} skills
   */
