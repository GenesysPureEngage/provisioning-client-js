...
(function(root, factory) {
   ...
   * @module provisioning/model/Skill
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>Skill</code>.
   * @alias module:provisioning/model/Skill
   * @class
   */
   ...
   * @param {module:provisioning/model/Skill} obj Optional instance to populate.
   * @return {module:provisioning/model/Skill} The populated <code>Skill</code> instance.
   */
