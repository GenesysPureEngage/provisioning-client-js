...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['provisioning/ApiClient', 'provisioning/model/OptionsPostResponseStatus'], factory);
   ...
   * @module provisioning/model/OptionsPostResponseStatusError
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new <code>OptionsPostResponseStatusError</code>.
   * @alias module:provisioning/model/OptionsPostResponseStatusError
   * @class
   */
   ...
   * @param {module:provisioning/model/OptionsPostResponseStatusError} obj Optional instance to populate.
   * @return {module:provisioning/model/OptionsPostResponseStatusError} The populated <code>OptionsPostResponseStatusError</code> instance.
   */
  ...
  /**
   * @member {module:provisioning/model/OptionsPostResponseStatus} status
   */
