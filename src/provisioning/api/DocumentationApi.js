...
(function(root, factory) {
   ...
   * @module provisioning/api/DocumentationApi
   * @version 9.0.000.00.646
   */

  /**
   * Constructs a new DocumentationApi. 
   * @alias module:provisioning/api/DocumentationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:provisioning/api/DocumentationApi~swaggerDocCallback
     ...
     * Returns API description in Swagger format
     * @param {module:provisioning/api/DocumentationApi~swaggerDocCallback} callback The callback function, accepting three arguments: error, data, response
     */
